    ...
    <section ref={ref} className="relative py-32 overflow-hidden bg-black">
      ...
      <div className="relative container mx-auto px-4 z-10">
        ...
        >
          ...
          >
            Modia Properties is revolutionizing real estate, starting in Nigeria and expanding globally. We connect
            property owners, buyers, and renters through an innovative platform designed for seamless, secure, and
